...
const HeaderAlto = (props) => {
  return (
    <header className="headerAlto row">
      
      <div className="row p-0 m-0">
        <div className="col-lg-6 col-12 order-2 img-cover">
        ...
        <div className="logoDiv header py-1 py-xl-4">
              ...
              {/* <img
                    ...
                    className="logoImg"
                  ></img> */}
                <svg xmlns="http://www.w3.org/2000/svg" width="268.19" height="39.94" viewBox="0 0 268.19 39.94" className="logoImg">
